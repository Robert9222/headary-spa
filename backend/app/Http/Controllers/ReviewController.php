...
class ReviewController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json($this->withTranslations($review->fresh(['service'])), 201);
    }
    ...
    public function update(Request $request, Review $review)
    {
        ...
        $review->update($data);
        return response()->json($this->withTranslations($review->fresh(['service'])));
    }
    ...
    private function withTranslations(Review $review): array
    {
        $data = $review->toArray();
        $data['content'] = $review->getTranslations('content');
        return $data;
